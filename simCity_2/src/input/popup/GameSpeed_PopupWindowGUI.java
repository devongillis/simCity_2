...
public class GameSpeed_PopupWindowGUI extends PopupWindowGUI{

	public GameSpeed_PopupWindowGUI() {
		width = 32 * 4 + 32;
		height = 64;
		posY = 0;
		posX = 0;
	...
	public void closeWindow() {
		InterfaceGUI.topWindowGUI.buttons.get(TopButton.GAMESPEED).clicked = false;
		super.closeWindow();
	}
